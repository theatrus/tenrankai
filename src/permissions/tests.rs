...
fn create_test_gallery_config(name: &str) -> GallerySystemConfig {
    GallerySystemConfig {
        ...
        images_per_page: 50,
        thumbnail: crate::config::ImageSizeConfig { width: 300, height: 300 },
        gallery_size: crate::config::ImageSizeConfig { width: 800, height: 800 },
        medium: crate::config::ImageSizeConfig { width: 1200, height: 1200 },
        large: crate::config::ImageSizeConfig { width: 1600, height: 1600 },
...
mod scenario_tests {
    ...
    fn test_public_portfolio_scenario() {
        ...
        roles.insert("public_viewer".to_string(), Role {
        ...
        roles.insert("client".to_string(), Role {
        ...
        roles.insert("photographer".to_string(), Role {
    ...
    fn test_family_album_scenario() {
        ...
        roles.insert("family".to_string(), Role {
        ...
        roles.insert("extended_family".to_string(), Role {
        ...
        roles.insert("kids".to_string(), Role {
            name: "kids".to_string(),
            permissions: RolePermissions {
                can_view: true,
        ...
        let extended_perms = resolver.resolve_user_permissions(Some("uncle_joe")).unwrap();
    ...
    fn test_team_workspace_scenario() {
        ...
        roles.insert("team_member".to_string(), Role {
    ...
    fn test_folder_override_scenario() {
        ...
        folder_roles.insert("viewer".to_string(), Role {
            name: "viewer".to_string(),
            permissions: RolePermissions {
                can_view: true,
                can_download_medium: true,
        ...
        folder_roles.insert("trusted".to_string(), Role {
        ...
        let folder_resolver = PermissionResolver::new(&gallery_config.permissions, Some(&folder_config.permissions));
        ...
        let trusted_perms = folder_resolver.resolve_user_permissions(Some("trusted_friend")).unwrap();
    ...
    fn test_multiple_roles_scenario() {
        ...
        // Downloader role
        roles.insert("downloader".to_string(), Role {
        ...
        user_roles.push(UserRole {
            ...
            roles: vec!["contributor".to_string(), "moderator".to_string(), "downloader".to_string()],
        });
        ...
        let merged_perms = resolver.resolve_user_permissions(Some("power_user")).unwrap();
    ...
    fn test_event_photography_scenario() {
        ...
        wedding_roles.insert("wedding_guest".to_string(), Role {
        ...
        wedding_roles.insert("bride_groom".to_string(), Role {
        ...
        corp_roles.insert("attendee".to_string(), Role {
        ...
        corp_roles.insert("corp_pr".to_string(), Role {
        ...
        // Test wedding folder
        let wedding_resolver = PermissionResolver::new(&gallery_config.permissions, Some(&wedding_folder.permissions));
        ...
        // Bride/Groom
        let bride_perms = wedding_resolver.resolve_user_permissions(Some("jane_smith")).unwrap();
        assert!(bride_perms.can_download_original);
        assert!(bride_perms.can_set_picks);
        
        // Test corporate folder
        let corp_resolver = PermissionResolver::new(&gallery_config.permissions, Some(&corporate_folder.permissions));
        ...
        // PR Manager
        let pr_perms = corp_resolver.resolve_user_permissions(Some("pr_manager")).unwrap();
